...
function hugeit_forms_custom_scripts()
{
    ...
    if (isset($_POST['submit'])) {
        hugeit_contact_save_custom_scripts();
    }
...
('form_button_fullwidth', 'Form Button Fullwidth', 'Form Button Fullwidth', '6', 'off'),
...
('form_button_reset_border_radius', 'Form Button Reset Border Radius', 'Form Button Reset Border Radius', '6', '1'),
