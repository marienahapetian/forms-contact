...
class Hugeit_Contact_Theme_Options extends WPDEV_Settings_API
{
                        ...
                        <tbody>
                            <?php foreach ($themes as $theme):?>
                                <tr>
                                    ...
                                    <td ><span><a href="admin.php?page=hugeit_forms_theme_options&task=edit_theme#<?php echo str_replace(' ','_',strtolower($theme->name));?>"><?php echo $theme->name;?></span></a></td>
                                    <td ><span><?php echo $theme->last_update;?></span></td>
                                    <td ><a  href="#" onclick="alert('This option is disabled for free version. Please upgrade to pro license to be able to use it.');	" >Delete <i>(pro)</i></a></td>
                                </tr>
                            <?php endforeach;?>
                        </tbody>
                    </table>
